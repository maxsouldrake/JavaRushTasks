...
public class Model {
    ...
    private LevelLoader levelLoader = new LevelLoader(Paths.get("D:\\other\\JAVA\\JavaRushTasks\\4.JavaCollections\\src\\com\\javarush\\task\\task34\\task3410\\res\\levels.txt"));
    ...
    public void checkCompletion() {
        ...
        for (Home home : gameObjects.getHomes()) {
            for (Box box : gameObjects.getBoxes()) {
                if ((box.getX() == home.getX()) && (box.getY() == home.getY())) i ++;
            }
        }

        if (i == gameObjects.getBoxes().size()) eventListener.levelCompleted(currentLevel);
    }
}
